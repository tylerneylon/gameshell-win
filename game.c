...
// Disable visual studio's float truncation warning.
...
void game__init() {
  ...
  glhelp__error_check;
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, tex_w, tex_h, 0, GL_RGBA, GL_UNSIGNED_BYTE, pixels);
  glhelp__error_check;
